...
echo "begin test"scp -r /home/peach/Desktop/Github/FrameworksEC/Frameworks/CypressEC client@192.168.0.102:/home/client/
echo "start test [$(date)]" >> LOGFILE
T="$(date +%s%N)"
#node ./test/action1.js
npx nightwatch $1
...
#run_files "./test/action1.js"
run_files "./NightwatchEC/test/*"
