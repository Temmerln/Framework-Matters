...
T="$(date +%s%N)"
#npx playwright test ./tests/playwright_actions/action1.spec.js --project chromium
npx playwright test $1 --project chromium
...
#run_files "./tests/playwright_actions/action2.js"
run_files "./PlaywrightEC/tests/playwright_actions/*"
